...
<header id="header"><!--header-->
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 9561920722</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> patanjalishop@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
    ...
    <img src="images/home/w2.jpg" width="1200" height="400" alt="" /></a></center>
						</div>
